...
import front from "../assets/Frontend.jpeg";
import back from "../assets/Backend.jpeg";


export default function Team() {
    const teamMembers = [
        { name: "Asim Afridi", role: "Frontend Developer", imageUrl: front },
        { name: "Asim Orakzai", role: "Backend Developer", imageUrl: back },
    ];
    ...
    return (
        <div ref={teamRef} className="py-10 bg-gray-100">
            ...
            {/* Team Members Grid */}
            <div className="grid  sm:grid-cols-1 md:grid-cols-2  gap-8 w-4/5 mx-auto">
